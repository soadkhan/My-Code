...
int main(void) {
    ...
    if(mi == 'b') if(( b - ( n / (se+1) ) ) <=0 ) fl = 1 ;
    if(mi == 'g') if(( g - ( n / (se+1) ) ) <=0 ) fl = 1 ;
    ...
    if(g>b){
        while(4){
            if(g>=se){
                g-=se ;
                rep1(se , i) ans.push_back('G') ;
                vora+=se ;
            }
            else {
                rep1(g , i) ans.push_back('G') ;
                vora+=g ;
                g= 0 ;
            }
            if(vora==n) break ;
        ...
        while(4){
            ...
            if(se>=b){
                rep1(b , i) ans.push_back('B') ;
                rep1(b , i) ans.push_back('G') ;
                break ;
            }
            rep1(se , i) ans.push_back('B') ;
            rep1(se, i) ans.push_back('G') ;
            vora+= (2*se)  ;
            b-=se ;
            g-=se ;
