...
int main(void) {
    ...
    while(cin>>get){
        int l = get.length();
        int d = ((get[0]-48)*10+(get[1]-48));
        int c = ((get[2]-48)*10+(get[3]-48));
        int b = ((get[4]-48)*10+(get[5]-48));
        int a = ((get[6]-48)*10+(get[7]-48));
        double ans = (double)(a + b*100 + c*60*100 + d*60*60*100)*125/108;
       // cout<<a<<" "<<b<<" "<<c<<" "<<d<<endl;
        printf("%07.0lf\n",floor(ans));
    }
